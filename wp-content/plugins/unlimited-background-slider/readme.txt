...
Donate link: 
Tags:background image slider, background slider, full page background slider, full width background slider, full width image slider, image slider, javascript rotator, javascript slider, jquery rotator, jquery slider, photo gallery, photo rotator, Photo Slider, picture slider, responsive full width background slider, responsive picture slider, responsive rotator, responsive slider, responsive slideshow, rotator, slider, slideshow, wordpress photo gallery, wordpress slider, wordpress slider plugin, wordpress slideshow
...
[See it live Demo here:](http://usb.usgamesound.com/).
...
If you are looking for more options then [check out the pro version](https://edatastyle.com/product/unlimited-background-slider/) of the plugin.

For Quick support please check WP
Responsive menu [Support forum](https://edatastyle.com/dwqa-questions).
