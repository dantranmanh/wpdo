...
function ed_bg_pro_info($post_type) {
  ...
  <br>
  <a style="display:inline-block; background:#33b690; padding:8px 25px 8px; border-bottom:3px solid #33a583; border-radius:3px; color:white;" class="wpd_pro_btn" target="_blank" href="https://edatastyle.com/product/unlimited-background-slider/">See all PRO features ($7)</a></div>
